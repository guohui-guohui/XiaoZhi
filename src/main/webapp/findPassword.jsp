    ...
    <div class="panel" style="width: 300px;">
        <div class="middle-box text-center loginscreen  animated fadeInDown">
            <div>
                ...
                <form class="" role="form" action="${appname}/user/findPassword" method="post" enctype="multipart/form-data">
                    <div class="form-group">
                        <input type="text" class="form-control" name="name" placeholder="请输入你的用户名，用户名忘记请注册账号" required="required">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-2 col-sm-10">
                            ...
                            <button type="submit" class="btn btn-success"  style="float: right" id="btn_register">更改</button>
                            <br>去<a href="login.html">登录</a>
                        </div>
                    </div>
